...
print(fig1, '多激励功率对比分析.svg', '-dsvg');
% --- 图 7: 上调能力 ---
figure(fig_up);
hold off;
xlabel('时间 (小时)', 'FontSize', 23);
ylabel('上调能力 (kW)', 'FontSize', 23);
set(gca, 'FontSize', 19);
xlim([simulation_start_hour, simulation_start_hour + 24]); 
set(gca, 'XTick', x_ticks, 'XTickLabel', x_tick_labels);
grid on;
...
print(fig_up, '多激励上调能力对比.svg', '-dsvg');
% --- 图 8: 下调能力 ---
figure(fig_down);
hold off;
xlabel('时间 (小时)', 'FontSize', 23);
ylabel('下调能力 (kW)', 'FontSize', 23);
set(gca, 'FontSize', 19);
xlim([simulation_start_hour, simulation_start_hour + 24]); 
set(gca, 'XTick', x_ticks, 'XTickLabel', x_tick_labels);
grid on;
...
print(fig_down, '多激励下调能力对比.svg', '-dsvg');
% --- 图 9: 激励特性曲线 (已应用修正数据) ---
...
print(fig_curve, 'EV激励价格-聚合整体功率特性.svg', '-dsvg');
